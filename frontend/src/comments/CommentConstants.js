...
export const GET_COMMENTS_URL = `${api}/posts/`;

// `POST /comments/:id` | Used for voting on a comment.
export const GET_VOTE_COMMENT_URL = `${api}/comments/`;
...
export const CREATE_NEW_COMMENT_URL = `${api}/comments`;

// `PUT /comments/:id` | Edit the details of an existing comment. | **timestamp** - timestamp. Get this however you want. <br> **body** - [String]
export const UPDATE_EXISTING_COMMENT_URL = `${api}/comments/`;

// `DELETE /comments/:id` | Sets a comment's deleted flag to `true`.
export const DELETE_COMMENT_URL = `${api}/comments/`;